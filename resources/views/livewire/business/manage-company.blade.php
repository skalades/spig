                ...
                <div class="bg-white rounded-[3rem] p-10 shadow-xl border border-gray-50">
                    <div class="flex items-center justify-between mb-8">
                        <div>
                            ...
                            <p class="text-gray-400 font-bold text-sm mt-1">Kelola katalog alat yang disewakan</p>
                        </div>
                    ...
                    @if($isAddingItem)
                        <form wire:submit.prevent="saveInventoryItem" class="bg-gray-50 p-8 rounded-[2rem] border border-gray-100 mb-10 relative">
                            ...
                            <h4 class="text-lg font-black text-iaspig-brown mb-6">Tambah Alat Baru</h4>
                            
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                <div class="space-y-2">
                                    <label class="text-[10px] font-black uppercase tracking-widest text-gray-400 ml-4">Nama Alat</label>
                                    <input type="text" wire:model="item_name" placeholder="Cth: Leica TS16" class="w-full bg-white border-none rounded-2xl px-6 py-4 focus:ring-2 focus:ring-iaspig-orange font-bold text-iaspig-brown shadow-sm">
                                ...
                                <div class="space-y-2">
                                    <x-iaspig.custom-select 
                                        ...
                                        :options="[
                                            ...
                                            ['value' => 'Echo Sounder', 'label' => 'Echo Sounder'],
                                            ['value' => 'Scanner', 'label' => '3D Laser Scanner'],
                                            ['value' => 'Aksesoris', 'label' => 'Aksesoris (Prisma, Statif, dll)'],
                            ...
                            <div class="space-y-2 mb-6">
                                <label class="text-[10px] font-black uppercase tracking-widest text-gray-400 ml-4">Deskripsi Alat (Kondisi/Kelengkapan)</label>
                            ...
                            <div class="space-y-2 mb-8">
                                <label class="text-[10px] font-black uppercase tracking-widest text-gray-400 ml-4">Foto Alat</label>
                            ...
                            <div class="flex justify-end">
                                <button type="submit" class="bg-iaspig-brown text-white px-8 py-4 rounded-xl font-black text-xs uppercase tracking-widest hover:bg-iaspig-orange transition-colors flex items-center gap-2">
                                    <span wire:loading.remove wire:target="saveInventoryItem">Simpan Alat</span>
                    ...
                    <div class="space-y-4">
                        @forelse($company->inventories as $item)
                            <div class="flex items-center gap-6 p-4 rounded-2xl border border-gray-100 hover:border-iaspig-orange/30 transition-colors bg-white group">
                                ...
                                <div class="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                    <button wire:click="deleteItem({{ $item->id }})" wire:confirm="Yakin ingin menghapus alat ini?" class="w-10 h-10 rounded-xl bg-red-50 text-red-500 flex items-center justify-center hover:bg-red-500 hover:text-white transition-colors">
                                        <i class="ri-delete-bin-line"></i>
                                    </button>
                                </div>
                            </div>
                        @empty
                            <div class="text-center py-12 bg-gray-50 rounded-[2rem] border-2 border-dashed border-gray-200">
                                ...
                                <p class="text-gray-400 text-sm mt-2">Anda belum menambahkan alat apapun ke katalog rental.</p>
                            </div>
                        @endforelse
                    </div>
                </div>
